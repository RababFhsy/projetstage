...
<body>
	...
	<div class="content mt-3">
		<div class="col-sm-8 col-lg-6 alert alert-light" style="margin-left: 200px">
		<div style="margin-left: 58px" >
		 <h3 class="text-dark">Formulaire Admin</h3>
	     </div>
			<form method="POST" action="add_a.php" >
                ...
                <br>		
				<div class="form-group">
					<button class="btn btn-primary form-control" type="submit" name="save" ><h6>Enregistrer</h6></button>
				</div>
			</form>
       </div>
       <style>
			...
			<table class="table table-hover">
				...
				<tbody>
					...
					<tr>
						...
						<td> <a class="btn btn-outline-danger btn-sm" href="deleteadmin.php?id=<?php echo $fetch['id']?>">Supprimer</a></td>
					</tr>
