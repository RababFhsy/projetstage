...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div><a  class="btn btn-outline-success"  href="add_users1.php"> <i class="fa fa-plus" aria-hidden="true"></i>  compte Médecin  </a> 
         <!-- <a  class="btn btn-outline-primary" style="width : 150px" href="add_users.php"><i class="fa fa-refresh" aria-hidden="true"></i>   Actualiser </a> -->
     </div></br>
                <div></div></br>
